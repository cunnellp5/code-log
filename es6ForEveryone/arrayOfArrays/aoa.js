...
//  const foundCode = posts.find((post) => post.code === code);
// const indexed = posts.findIndex(post => post.code === code);
// console.log(indexed)


const ages = [33, 14, 5, 77];
// at least one adult in the group?
const adultPresent = ages.some(age => age >= 18);
console.log(adultPresent)
// is everyone old enough to drink?
oldEnough = ages.every(age => age >= 18)
