...
// exhibitions. Miriam, the interior architect, comes up with a plan to remove the
//  most boring exhibitions. She gives them a rating, and then removes the one with
//   the lowest rating.
//
...
function removeSmallest(numbers) {
  ...
  var removeMin = numbers.splice(index,1)
  return numbers
}
