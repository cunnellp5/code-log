...
// matters. Each element of the output array should be the rotated version of
// the previous element. The output array SHOULD be the same length as the input
//  string The function should return an emptry array with a 0 length string, '',
//   as input
...
function rotate(str){
  ...
  for (var i = 0; i < str.length; i++) {
    var letter = ray.shift();
    var join = ray.join('') + letter
    ray = join.split('')
    holder.push(join);
  }
  return holder;
