...
When pinocchio is lying he stutter a bit.If word1 is followed by word2 where
 word2 contains whole word1(case insensitive) you can tell that pinocchio is lying.
...
var lie = "lie Lie sweet sweetener lies."
...
console.log(extendPinocchioNose(lie));
